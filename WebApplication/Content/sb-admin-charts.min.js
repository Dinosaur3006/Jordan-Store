...
var ctx = document.getElementById("myAreaChart"),
    myLineChart = new Chart(ctx, {
        type: "line", data: {
            ...
            datasets: [{
                ...
                pointHitRadius: 20,
                pointBorderWidth: 2, data: [1e4, 30162, 26263, 18394, 18287, 28682, 31274, 33259, 25849, 24159, 32651, 31984, 38451]
            }]
        },
        options: {
            scales: {
    ...
    myLineChart = new Chart(ctx, {
        type: "bar", data: {
            labels: [ViewBag.Year]/*["January", "February", "March", "April", "May", "June"]*/,
            datasets: [{
                label: "Order",
                backgroundColor: "rgba(2,117,216,1)",
                borderColor: "rgba(2,117,216,1)",
                data: [ViewBag.Total]/*[4215, 5312, 6251, 7841, 9821, 14984]*/
            }]
        },
        options: {
            scales: {
